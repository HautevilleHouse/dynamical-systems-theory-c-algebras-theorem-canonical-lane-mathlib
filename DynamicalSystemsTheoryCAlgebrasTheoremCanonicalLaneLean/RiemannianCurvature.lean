...
This module defines the local formal objects used by the C*-algebra dynamics
route: a three-dimensional Riemannian manifold package, Riemann curvature,
Ricci tensor, and scalar curvature. The fields record proof obligations;
later modules compose those obligations into the dynamics route.
-/
